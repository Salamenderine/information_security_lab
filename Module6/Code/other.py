...
MAX_LEN = 31
TOOL_PATH = "/home/isl/pin-3.11-97998-g7ecce2dac-gcc-linux-master/source/tools/SGXTrace"

def create_output(out_id, cracked_password):
	out_path = f"/home/isl/t2_2/output/oput_{out_id}"
	os.makedirs(os.path.dirname(out_path), exist_ok=True)
	output_file = open(out_path, "w") 
	output_file.write(cracked_password)
	output_file.close()

def create_trace(guess, ch, id):
	os.chdir(TOOL_PATH)
	out_path = f"/home/isl/t2_2/traces/trace_{ch}"
	os.makedirs(os.path.dirname(out_path), exist_ok=True)
	command = f"../../../pin -t ./obj-intel64/SGXTrace.so -o {out_path} -trace 1 -- ~/t2_2/password_checker_2 {guess}"
	os.system(command)	

def delete_traces():
	trace_path = "/home/isl/t2_2/traces"
